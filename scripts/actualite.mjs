...
// une piste de moins un matin doit pouvoir se rattacher à sa cause. Et le
// même effort « medium », pour la même raison de quota (recherche.mjs).
const MODELE = process.env.MATINALE_GEMINI_MODELE ?? 'gemini-3.8-flash-medium';
...
// le 18 septembre 2026, les cinq volets ont été coupés au milieu de leur
// réponse. Le nôtre dépasse d'une minute, pour le cas où il ne s'arrêterait
// pas. Les cinq tournent ensemble : c'est le plus lent qui fait attendre la
// session.
const DELAI_CLI = '12m';
