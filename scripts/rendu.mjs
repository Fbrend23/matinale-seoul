...
if (code !== 0) {
  ...
  const attendus = [
    ...
    // Le deuxième item de la fixture porte link_dead_at : sa source sort
    // sans lien, et le dit.
    ['briefs/brief-2026-09-04/index.html', ['application/ld+json', 'class="meteo"', 'class="source-morte"', 'page retirée']],
