...
- `lot` : le lot **entier**, corrigé, de la même forme exacte que celui reçu, la section avec sa clé, ou les événements. L'objet entier, pas un correctif : ce qui est rendu est ce qui est publié.
