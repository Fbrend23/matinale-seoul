...
| `address` | string | nullable ; l'adresse routière coréenne vue par l'agent. La page Événements la géocode dans le navigateur (API Naver Maps) pour poser un pin ; rien de Naver n'est stocké, ses conditions l'interdisent. Sans hangul, l'ingestion retire le champ |
